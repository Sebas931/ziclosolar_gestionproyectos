                        ...
                        <div className="flex-1">
                          ...
                          {project.created_at && (
                            <div className="text-xs text-muted-foreground mt-1">
                              <p>Creado: {new Date(project.created_at).toLocaleDateString()} por {project.created_by || 'sistema'}</p>
                              {project.updated_at && project.updated_at !== project.created_at && (
                                <p>Actualizado: {new Date(project.updated_at).toLocaleDateString()} por {project.updated_by || 'sistema'}</p>
                              )}
                            </div>
                          )}
                        </div>
                      ...
                      <div key={engineer.id} className="flex justify-between items-center p-3 border rounded">
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => editEntity(engineer, 'engineer')}
                          >
                            <Edit2 className="h-4 w-4" />
                          </Button>
          ...
          <form onSubmit={handleEntitySubmit} className="space-y-4">
            ...
            {currentEntity === 'engineer' && (
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="engineer_status">Estado</Label>
                  <Select value={entityForms.engineer.status || 'active'} onValueChange={(value) => setEntityForms({
                    ...entityForms,
                    engineer: {...entityForms.engineer, status: value}
                  })}>
                    <SelectTrigger>
                      <SelectValue placeholder="Seleccionar estado" />
                    </SelectTrigger>
